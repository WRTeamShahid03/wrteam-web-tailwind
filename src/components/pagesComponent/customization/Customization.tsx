      ...
      <section className="container commonMT space-y-8 md:space-y-12 lg:space-y-20">
        <div className="flexColCenter commonTextGap lg:w-[70%] m-auto text-center">
          <h2 className="sectionTitle">
            Want Customization in <span>Our Products?</span>
          </h2>
          <p className="sectionPara">
            Customize our products to fit you perfectly! Just tell us what you
            need, and we&apos;ll make it happen. Your happiness is our top
            priority, so let&apos;s work together to create exactly what you
            want.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 commonBg rounded-[16px] py-[40px] md:py-[70px] between-1200-1399:px-[20px] px-[20px] md:px-[40px] relative gap-y-12 lg:gap-4 2xl:gap-6">
          {data.map((item: servicesProcessDataTypes) => {
            return (
              <div
                className="flexColCenter gap-4 text-center relative"
                key={item.id}
              >
                <div className="rounded-full border-[2px] border-[#2e71fe] p-2 relative">
                  <div className="primaryBg absolute top-0 right-10 z-[1] rounded-full p-0.5">
                    <span className="text-white border border-white border-dashed rounded-full w-[44px] h-[44px] flexCenter font-extrabold text-lg">
                      0{item.id}
                    </span>
                  </div>
                  <Image
                    ...
                    loading="lazy"
                    alt={item.title}
                    className="w-[206px] h-[206px] rounded-full object-cover brightness-[0.5]"
                  />
                </div>
          ...
          <Image
            ...
            loading="lazy"
            alt="arrow"
            className="max-1199:hidden w-[140px] 2xl:w-[164px] h-auto absolute top-[24%] left-[28%] m-auto"
          />
          <Image
            src={arrowImg}
            height={0}
            ...
            loading="lazy"
            alt="arrow"
            className="max-1199:hidden w-[140px] 2xl:w-[164px] h-auto absolute top-[24%] right-[28%] m-auto"
          />
          ...
          <Image
            ...
            loading="lazy"
            alt="line"
            className="hidden md:block w-[28%] h-auto absolute top-[] right-0 m-auto rotate-180 -z-[1]"
          />
          <Image
            src={line}
            height={0}
            ...
            loading="lazy"
            alt="line"
            className="hidden md:block w-[28%] h-auto absolute bottom-0 left-0 m-auto -z-[1]"
          />
        </div>
      </section>
          ...
          <div className="grid between-1200-1399:grid-cols-2 xl:grid-cols-2 gap-y-8 md:gap-y-12 between-1200-1399:gap-6 xl:gap-6">
            <div className="flexColCenter commonTextGap">
              ...
              <Image
                ...
                loading="lazy"
                alt="form-side-img"
                className="w-auto h-auto rounded-[16px]"
              />
            </div>
