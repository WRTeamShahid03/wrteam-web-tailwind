    ...
    return (
        <div className="container commonMT space-y-8 md:space-y-12 lg:space-y-16">
            <div className='flexCenter'>
                <h3 className='text-xl md:text-3xl lg:text-4xl/[50px] font-[500] [&_span]:primaryColor !font-roboto text-center lg:text-start'>You Gonna Love This Bundle If <span>You're…</span></h3>
            </div>
                ...
                {categories.map((category: servicesProcessDataTypes) => (
                    ...
                    >
                        <div className="rounded-full p-3 bg-[#316be71a]">
                            <Image src={category.img} height={0} width={0} alt={category.title} className='w-[42px] h-[42px]' />
                        </div>
