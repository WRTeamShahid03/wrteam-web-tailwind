            ...
            <section className='max-1680:!container 2xl:max-w-[1620px] mx-auto commonMT space-y-8 md:space-y-12 lg:space-y-20'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 lg:gap-8'>
                    {packages.map((pkg: installationPackagesDataTypes, index) => (
                        <div
                            key={pkg.id}
                            className={`flex flex-col h-full p-4 lg:p-5 border-[1.5px] rounded-[16px] relative bg-white ${index === 4 ? "primaryBorder xl:mt-0 lg:mt-6 sm:mt-6 mt-6" : "border-[#2E71FE29]"
                                }`}
                        >
                            {
                                index === 4 && (
