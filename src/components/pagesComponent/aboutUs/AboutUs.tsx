      ...
      <section className='container commonMT'>
        <div className='grid grid-cols-12 gap-y-10 md:gap-y-32 between-1200-1399:gap-y-40 xl:gap-16'>
          <div className="max-1199:col-span-12 col-span-7 between-1200-1399:col-span-12 relative">
            <div className='relative'>
              ...
              <div className='bg-[#212121] hidden md:flexColCenter !items-start text-white p-3 md:p-6 gap-6 md:gap-12 group transition-all duration-300 h-max border-white border-[8px] rounded-[20px] absolute right-4 md:-right-[34px] -bottom-[60px] md:-bottom-[86px] after:content-[""] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0 after:transition-all after:duration-300 group-hover:after:h-16 after:bg-gradient-to-b from-[hsla(0,8%,74%,0.427)] to-[hsla(0,8%,74%,0.427)] after:opacity-[0.4] overflow-hidden'>
                ...
                <h1 className='text-xl md:text-4xl font-semibold'>Business Solution</h1>
              </div>
          ...
          <div className='flexColCenter !items-start commonTextGap max-1199:col-span-12 between-1200-1399:col-span-12 col-span-5 w-full'>
            <span className='sectionTag'>Get to <span>know more</span></span>
            <h1 className='sectionTitle'>Your Work Partner in <span>Transforming</span> Your Vision into Reality.</h1>
            <p className='sectionPara'>WRTeam is, a software development company located in Bhuj - India, serving IT services & digital solutions around the globe.</p>
            <p className='sectionPara'>We're a team of experienced & expert developers with a specialization in making mobile apps, websites, and digital solutions tailored to your business.</p>
            <p className='sectionPara'>WRTeam is the elite author on Envato selling digital solutions ( pre-built source codes) to make applications & websites 5X faster, make websites & apps for e-commerce, hotels & restaurants, real estate, school management, mobile games, etc.</p>
            <p className='sectionPara'>WRTeam is the one-stop solution for all your digital needs, WRTeam is your working partner that helps you with its expertise in web & app development, UI/UX designing, digital marketing, etc.</p>
          </div>
      ...
      <section className='container commonMT'>
        <div className='grid grid-cols-12 gap-y-10 md:gap-y-12 xl:gap-20'>
          ...
          <div className='flexColCenter !items-start commonTextGap max-1199:col-span-12 between-1200-1399:col-span-12 col-span-6 w-full'>
            <span className='sectionTag'>Our <span>Vision</span></span>
            <h2 className='sectionTitle'>Inspiring <span>Growth</span> Through Innovative <span>Mobile and Web</span> Solutions</h2>
            <p className='sectionPara'>At WRTeam, we manifest to be the best provider of software solutions including source codes to make apps & websites and services like IT consultation, software development, UI/UX designing, and digital marketing.</p>
            <p className='sectionPara'>Having a website or app is crucial for business growth, we are committed to providing innovative, stunning, and smooth software solutions that are perfectly made for your business.</p>
            <p className='sectionPara'>We aim to be the best IT company known for its creativity, and high-quality software solutions, focussing on client satisfaction.</p>
          </div>
      ...
      <section className='container commonMT'>
        <div className='grid grid-cols-12 gap-y-10 md:gap-y-12 between-1200-1399:gap-y-24 xl:gap-28'>
          ...
          <div className='max-1199:order-1 flexColCenter !items-start commonTextGap max-1199:col-span-12 between-1200-1399:col-span-12 col-span-6 w-full'>
            <span className='sectionTag'>Our <span>Mission</span></span>
            <h3 className='sectionTitle'>Bring Change With <span>Best Software</span> Solutions.</h3>
            <p className='sectionPara'>We are on a mission to bring revolution in the way of making websites and applications, we make it possible with our easily customizable & error-free source codes.</p>
            <p className='sectionPara'>We aim to help businesses enhance their virtual presence with our best software solutions, with a strong focus on client satisfaction and growth.</p>
          </div>
            ...
            <div className="space-y-12">
              <div className='flexColCenter !items-start commonTextGap'>
                ...
                <h4 className="sectionTitle lg:w-[85%]">
                  <span>Integrity</span> and <span>Creativity</span> Lead to Success.
                </h4>
              </div>
              ...
              <div className='flexColCenter !items-start gap-4'>
                {
                  valuesListPoints.map((item: valuesList) => {
                    return <div className='flex items-center gap-2 font-semibold textSecondary' key={item.id}>
              ...
              <div>
                <Link href={'/hire-us'} className='commonBtn'>Hire Us</Link>
              </div>
            </div>
