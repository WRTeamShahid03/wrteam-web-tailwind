...
const ProductDetailsSideCard: React.FC<ProductDetailPageProps> = ({ data }) => {
    ...
    return (
        <div>
        <div className="w-max max-1199:relative fixed max-1199:top-0 top-[194px] mb-8 bg-[#0d6efd0d] p-6 rounded-2xl gap-5 border border-[#0000002d] overflow-hidden max-1199:m-auto">
            <div>
              {/* Upper Section */}
