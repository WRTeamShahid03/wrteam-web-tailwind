    ...
    <Layout>
        ...
        <div className="grid max-1199:grid-cols-1 grid-cols-2 gap-8">
          <div className="flexColCenter !items-start commonTextGap">
            ...
            <p className="sectionPara">
              Our app development service is available to meet your unique
              business needs and create high-quality, user-friendly mobile
              applications.
            </p>
          </div>
          ...
          <div className="flexCenter">
            <div className='flexCenter relative before:contents-[""] before:absolute before:top-[6px] before:left-0 before:right-0 before:bottom-0 before:m-auto before:w-[86%] before:h-[96%] before:primaryBg before:-z-[1] before:rotate-[185deg] before:rounded-[16px]'>
              <Image
                ...
                width={0}
                loading="lazy"
                alt="best android & ios app development company -WRTeam Bhuj- gujrat"
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="flexColCenter !items-start commonTextGap">
            ...
            <h4 className="sectionTitle">
              Unleashing the Potential of the Best Mobile{" "}
              <span>App Development</span> Service.
            </h4>
          </div>
          <div className="flexCenter">
            <p className="sectionPara">
              Discover unparalleled benefits with the best app development
              service provider. We are committed to delivering innovative &
              efficient apps to elevate your online success.
            </p>
          </div>
        </div>
      ...
      <section className="container commonMT space-y-16">
        <ProcessSect
          ...
          isReverse={false}
          sectionTitle="How Does Our App Development Team Create an App For You?"
          blueText="App Development"
          sectionImg={processImg}
          alt="every work is done in systematic way at best it company WRTeam bhuj"
        />
            ...
            <div className="grid grid-cols-12 gap-y-4">
              <div className="max-1199:col-span-12 col-span-5 flexColCenter !items-start commonTextGap border-r p-4 md:p-12">
                ...
                <h6 className="sectionTitle">
                  App <span>Development</span> Services Tailored for{" "}
                  <span>Latest Platforms</span>
                </h6>
                <p className="sectionPara">
                  Our app development mastery is across iOS, and Android and is
                  compatible with cross platforms. Tailored solutions, universal
                  impact.
                </p>
              </div>
