...
const UiUxDesign: React.FC = () => {
    ...
    return (
        <Layout>
            <Breadcrumb title='UI-UX' blueText='Servies' secondElement='Services' thirdElement='UI-UX-Design' />
            <section className='container commonMT'>
                <div className="grid max-1199:grid-cols-1 grid-cols-2 gap-8">
                    <div className='flexColCenter !items-start commonTextGap'>
                        <span className='sectionTag'>UI-UX <span>Services</span></span>
                        <h2 className='sectionTitle'>Make Innovative App & Web Designs with the Best <span>UI/UX</span> Designers</h2>
                        <p className='sectionPara'>Our Best UI/UX design service focuses on creating innovative & unique designs for your website & application tailored to your needs. Our UI/UX designers are experienced & expert at making unique, user-friendly websites & applications.</p>
                    </div>
            ...
            <section className='container commonMT space-y-12'>
                <div className='grid lg:grid-cols-2 gap-6'>
                    <div className='flexColCenter !items-start commonTextGap'>
                        ...
                        <h4 className="sectionTitle">The Transformative Benefits of Our <span>UI/UX</span> Solutions</h4>
                    </div>
                    <div className='flexCenter'>
                        <p className='sectionPara'>Transform your digital presence with our UI/UX designing service. enhance user experiences, attract new audiences, and strategically upboost your brand's success.</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white shadow-[0px_0px_46px_#2830421F] relative z-[2] py-4 md:py-8 lg:py-12 rounded-[16px] overflow-hidden">
                        <div className="grid grid-cols-12 gap-y-4">
                            <div className="max-1199:col-span-12 col-span-5 flexColCenter !items-start commonTextGap border-r p-4 md:p-12">
                                ...
                                <h6 className='sectionTitle'>Make Dynamic <span>UI/UX</span> Designs with <span>Leading Tools</span> for Your Digital Presence.</h6>
                                <p className='sectionPara'>From Illustrator's finesse to Figma's innovation, we blend pixel-perfect precision from Photoshop with Adobe XD's seamless design.</p>
                            </div>
