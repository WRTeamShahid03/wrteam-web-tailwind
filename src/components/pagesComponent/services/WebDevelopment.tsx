...
const WebDevelopment = () => {
    ...
    return (
        <Layout>
            <Breadcrumb title='Web' blueText='Development' secondElement='Services' thirdElement='Web Development' />
            <section className='container commonMT'>
                <div className="grid max-1199:grid-cols-1 grid-cols-2 gap-8">
                    <div className='flexColCenter !items-start commonTextGap'>
                        <span className='sectionTag'>Web <span>Development</span></span>
                        <h2 className='sectionTitle'>Avail Web Development Services and Build <span>Stunning Websites</span> with the <span>Best IT Company</span> Personalized for Your Business.</h2>
                        <p className='sectionPara'>With over 7 years of experience, we create personalized business websites for E-commerce, Restaurants, Real Estate, Trivia games, and more. We aim to deliver fully functional, stunning websites with modern, user-friendly UI/UX.</p>
                    </div>
            ...
            <section className='container commonMT space-y-12'>
                <div className='grid lg:grid-cols-2 gap-6'>
                    <div className='flexColCenter !items-start commonTextGap'>
                        ...
                        <h4 className="sectionTitle">Unleashing the Potential of the Best <span>Web Development</span> Company</h4>
                    </div>
                    <div className='flexCenter'>
                        <p className='sectionPara'>Discover unparalleled benefits with the top web development company. We are committed to delivering innovative & efficient websites to elevate your online success.</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white shadow-[0px_0px_46px_#2830421F] relative z-[2] py-4 md:py-8 lg:py-12 rounded-[16px] overflow-hidden">
                        <div className="grid grid-cols-12 gap-y-4">
                            <div className="max-1199:col-span-12 col-span-5 flexColCenter !items-start commonTextGap border-r p-4 md:p-12">
                                ...
                                <h6 className='sectionTitle'>We <span>Build</span> Dynamic Solutions with Leading <span>Web Development</span> Platforms</h6>
                                <p className='sectionPara'>Harness the power of advanced technology and next-level web development for an online presence that captivates attention!</p>
                            </div>
