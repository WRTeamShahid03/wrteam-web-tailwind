    ...
    <Layout>
        ...
        <div className="grid max-1199:grid-cols-1 grid-cols-2 gap-8">
          <div className="flexColCenter !items-start commonTextGap">
            ...
            <p className="sectionPara">
              ...
              marketing services, get every marketing service in one place from
              expert marketers.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="flexColCenter !items-start commonTextGap">
            ...
            <h4 className="sectionTitle">
              Avail <span>Digital Marketing</span> by Experts for Precise and
              Targeted Results.
            </h4>
          </div>
          <div className="flexCenter">
            <p className="sectionPara">
              Expand your business globally with digital marketing experts, get
              global reach, and cost-effective results by targeted advertising.
            </p>
          </div>
        </div>
      ...
      <section className="container commonMT space-y-16">
        <ProcessSect
          ...
          isReverse={false}
          sectionTitle="Grow your business with the Best Digital Marketing Services"
          blueText="Digital Marketing"
          sectionImg={processImg}
          alt="all types of digital marketing services are available at the best IT consultants-WRTeam Bhuj Gujrat"
        />
        ...
        <ProcessSect
          ...
          alt="detailed digital marketing work process report at WRTeam kutch"
        />
      </section>
          ...
          <div className="bg-white shadow-[0px_0px_46px_#2830421F] relative z-[2] py-4 md:py-8 lg:py-12 rounded-[16px] overflow-hidden">
            <div className="grid grid-cols-12 gap-y-4">
              <div className="max-1199:col-span-12 col-span-5 flexColCenter !items-start commonTextGap border-r p-4 md:p-12">
                ...
                <p className="sectionPara">
                  Experience excellence with our services, powered by top-notch
                  platforms for unmatched performance and innovation.
                </p>
              </div>
