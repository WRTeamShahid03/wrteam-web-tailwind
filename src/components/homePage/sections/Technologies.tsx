        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="flexColCenter !items-start commonTextGap">
            <span className="sectionTag">
              Technology <span>We Use</span>
            </span>
            <h3 className="sectionTitle">
              Our Developers Have a <span>Strong Grip</span> on Advanced{" "}
              <span>Technologies</span> to Enhance Your Website & App.
            </h3>
          </div>
          <div className="flexCenter">
            <p className="sectionPara">
              We are a team of web developers specialized in front-end,
              back-end, & full stack development using advanced technologies
              like laravel, Vue JS, Next JS, etc. Our team also has app
              developers specialized in making Android, iOS, & flutter
              applications.
            </p>
          </div>
        </div>
          ...
          <div className="secondaryBg p-6 md:p-14 shadow-[0_16px_36px_#2435525c] opacity-[0.9] rounded-[30px]">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-8 md:gap-12 justify-self-center">
              {techCardData.map((data: technologiesDataTypes) => {
                return (
                  <div className="flexColCenter gap-4 md:gap-6" key={data.id}>
                    <div className='bg-white group transition-all duration-300 hover:primaryBg flexCenter rounded-[15px] p-[30px] relative z-[1] after:contents-[""] after:absolute after:-bottom-[70px] md:after:-bottom-[100px] after:left-0 after:right-0 after:bg-white after:h-[70px] md:after:h-[100px] after:w-[6px] after:m-auto'>
                      <Image
                        ...
                        loading="lazy"
                        alt={data.alt}
                        className="w-full h-fw-full transition-all duration-300 group-hover:filter group-hover:brightness-0 group-hover:invert-[1]"
                      />
                    </div>
                    ...
                    <span className="text-white font-[600] text-lg">
                      {data.title}
                    </span>
                  </div>
                );
