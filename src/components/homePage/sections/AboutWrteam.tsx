            ...
            <div className='grid xl:grid-cols-2 gap-12 md:gap-16 xl:gap-64'>
                ...
                <div>
                    <div className='flexColCenter !items-start gap-4 md:gap-6'>
                        <span className='sectionTag'>About <span>WRTeam</span></span>
                        <h3 className='sectionTitle'>We are Committed to Providing our <span>Clients</span> with End-to-End <span>App and Website</span> Solutions.</h3>
                        <p className='sectionPara'>WRTeam has experience of more than 7 years as a software development company, our experienced web and app developers deliver results that reach all your requirements .</p>
                        <p className='sectionPara'>WRTeam is a team of web developers & app developers who are creative, dedicated, and experts in full stack development and UI/UX, using advanced technologies like Laravel, Flutter, Figma, etc.</p>
                        <Link href={'/about-us'} title='Discover More' className='commonBtn'>Discover More</Link>
                    </div>
                </div>
            </div>
        </section>
