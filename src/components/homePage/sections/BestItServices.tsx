...
const BestItServices: React.FC = () => {
    ...
    const item1bg: string = 'hover:bg-[#97b21e] hover:shadow-[0px_16px_36px_#97B21E5C]';
    const item2bg: string = 'hover:bg-[#EE8F27] hover:shadow-[0px_16px_36px_#EE8F275C]';
    const item3bg: string = 'hover:bg-[#FF0077] hover:shadow-[0px_16px_36px_#FF00775C]';
    const item4bg: string = 'hover:bg-[#57B0AF] hover:shadow-[0px_16px_36px_#57B0AF5C]';
        ...
        <section className='container commonMT'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                ...
                <div className='flexColCenter !items-start commonTextGap'>
                    <span className='sectionTag'>Best <span>IT Services</span></span>
                    <h2 className='sectionTitle'><span>Innovate, Implement, Succeed:</span> We Offer Every IT Service You need, all in <span>One Place.</span></h2>
                    <p className='sectionPara'>In the modern world having a digital presence is crucial, it's necessary to have a business website or app that leads to stronger administration & expansion. Remove limitations of place & time from your business with WRTeam's software services.</p>
                    <p className='sectionPara'>We offer all software services in one place, from designing a personalized mobile app & website to streamlining your business website & mobile app.</p>
                    <p className='sectionPara'>Our team has experienced UI/UX designers, web developers, native & flutter mobile app developers, and digital marketers to enhance your digital brand identity. Our experts are committed to delivering the best results and developing lifelong relationships.</p>
                </div>
                <div>
